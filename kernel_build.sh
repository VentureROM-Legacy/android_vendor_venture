...
if [ -f $DIR/out/target/product/$DEVICE/venture-$DEVICE-kernel-signed.zip ]; then
   mv $DIR/out/target/product/$DEVICE/venture-$DEVICE-kernel-signed.zip $DIR/out/target/product/$DEVICE/venture-$DEVICE-$VERSION-kernel-$DATE-signed.zip
else
